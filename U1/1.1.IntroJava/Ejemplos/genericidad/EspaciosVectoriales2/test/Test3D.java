...
class Test3D {
	...
	*/
	...
	public static void main (String[] args) {
		...
		Coordenada2D<Double> xy = new Coordenada2D<>( 3.4, -5.6 );
		...
		Coordenada3D<Double> xyz = new Coordenada3D<>( 3.4, -5.6, 3.3 );
		...
		// Polimorfismo
		Coordenada2D<Double> pqr = (Coordenada2D<Double>) xyz;
		...
		Coordenada3D<Double> ijk = (Coordenada3D<Double>) pqr;
		...
		Coordenada3D<Integer> abc = new Coordenada3D<Integer>(10, 20, 30);
